            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Service management</div>
            ...
            <div class="col-md-8">
              <div class="pull-xs-right" role="toolbar">
               ...
               <!--  <button class="btn btn-secondary" type="button" data-toggle="collapse" href="#qmenu" aria-expanded="false" aria-controls="qmenu">Open menu</button> -->
                <button class="btn btn-success" data-toggle="modal" data-target="#trackermodal"  onclick="clearall();">Add Service</button>
              </div>
            </div>
...
<div class="modal fade-scale" id="trackermodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
           <form method="POST" id="menuForm"  >
                  ...
                  <div class="row m-b-2">
                   ...
                   <div class="form-group col-sm-6">
                    <h4 class="demo-sub-title">Description arab</h4>
                     <textarea class="form-control" name="subdescarb" id="subdescarb"></textarea> 
                   </div>  
     ...
     <script type="text/javascript">
      ...
      function getsubmenus(){
           $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_service/display_submenu');?>/",
      ...
      $("#menuForm").submit(function(e) {
        ...
        var form = $(this);
         $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_service/insertSubmenu');?>/",
      ...
      function editsubmenu(id){
        ...
        $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_service/editsubmenu');?>/",
             ...
             success: function(data){
              ...
              $('#submenuid').val(res.services_id);
              $('#submenuname').val(res.services_name);
              $('#submenunamearab').val(res.services_name_arab);
              
              $('#subdesc').val(res.services_description);
              $('#subdescarb').val(res.services_description_arab);
             
              $('#image1').val(res.services_pic); 
              $('#imagefill').html('<img  style="width:250px;height:200px;"src="<?php echo base_url();?>/uploads/'+res.services_pic+'">') 
              // $('#file1').val(res.file);
      ...
      function deletesubmenu(id,img){
        var result = confirm("Are you want to delete?");
          if (result) {
              $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_service/delete_submenu');?>/",
