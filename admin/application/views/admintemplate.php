...
<html lang="en-us">
  <head>
    ...
    <title>Awadal Murtaaji Admin</title>
  ...
  <body class="orchid mirage" style="overflow: visible;">
    ...
    <div class="mainmenu-block">
      ...
      <nav class="menu-block">
        <ul class="nav">
          <li class="nav-item mainmenu-user-profile">
              ...
              <div class="menu-block-label">
                ...
                <b>Awadalmurtaji</b><br><?php echo $usertype; ?>
              </div>  
        ...
        <ul class="nav">
          ...
          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_dashboard"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Main Menu</div></a></li>

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_service"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Service Type</div></a></li>

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_products"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Product manager</div></a></li>    

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_homslider"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Home Slider</div></a></li>

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_catelog"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Catelogs</div></a></li>    

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_project"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Projects</div></a></li>

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_gallery"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Gallery</div></a></li>

          <li class="menu-block-has-sub nav-item"><a class="nav-link" href="#"><i class="icon ion-monitor"></i>

              <div class="menu-block-label">Page Manager</div></a>
              ...
              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_servicepage">Service page</a></li>

              <!-- <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_contact">Lighting Solutions</a></li> -->
          ...
          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_login/logout">
      ...
      <div class="view-wrapper">
        ...
        <div class="topbar-wrapper">
          ...
          <div class="topbar-wrapper-mobile-nav"><a class="topbar-togger js-minibar-toggler" href="#"><i class="icon ion-ios-arrow-back hidden-md-down"></i><i class="icon ion-navicon-round hidden-lg-up"></i></a><a class="topbar-togger pull-xs-right hidden-lg-up js-nav-toggler" href="#"><i class="icon ion-android-person"></i></a>
            ...
            --><a class="topbar-wrapper-logo demo-logo" href="admin">AL MURTAJI</a>
          </div>
          <!-- END NAV FOR MOBILE-->
