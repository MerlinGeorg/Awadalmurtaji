            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Home Slider</div>
           ...
           <form method="POST" id="homsliderForm"  >
                  ...
                  <div class="row m-b-2">
                    ...
                    <div class="form-group col-sm-6">
                      ...
                      <input class="form-control focus " type="text" required="required" name="slidertitlearab" id="slidertitlearab">
                      
                    </div>

                    
                    <div class="form-group col-sm-6" >
                      <h4 class="demo-sub-title">Sub Title arab</h4>
                      <input class="form-control" type="text"   name="slidersubtitlearab"  id="slidersubtitlearab" >
                    </div>
                    </div>
      ...
      function editmenu(id){
        ...
        $.ajax({
             ...
             success: function(data){
              ...
              $('#slidertitlearab').val(res.homeslider_title_arab);
              $('#slidersubtitlearab').val(res.homeslider_subtitle_arab);
