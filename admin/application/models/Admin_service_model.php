<?php 
class Admin_service_model extends CI_Model 
{
 ...
 {
 	$query = $this->db->insert('services',$data1);
 ...
 {
 	$this->db->where('services_id',$menuid);
 ...
 {
 	$this->db->where('services_id',$submenu_id);
