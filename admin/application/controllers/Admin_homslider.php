...
class Admin_board extends CI_Controller {
	...
	public function editslider()
	{
		...
		$res = $this->Admin_homeslider_model->get_editslider($sid);
         ...
         if($getslider_id==$slider_id)
      	 {
            ...
            $data1 = array
			      (
			        ...
			        'homeslider_title_arab'=>$this->input->post('slidertitlearab'),
                    'homeslider_subtitle_arab'=>$this->input->post('slidersubtitlearab'),
