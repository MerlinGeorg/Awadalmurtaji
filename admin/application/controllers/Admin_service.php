...
class Admin_board extends CI_Controller {
    ...
    $a = array('content' => 'admin_service_view'
	...
	public function insertSubmenu()
	{
      ...
      $data1 = array
      (
       'services_name'=>$this->input->post('submenuname'),
       'services_description'=>$this->input->post('subdesc'),
       'services_name_arab'=>$this->input->post('submenunamearab'),
       'services_description_arab'=>$this->input->post('subdescarb'),
       'services_pic'=>$filename,
       'services_status'=>1,
       'services_date'=>$ins_date
      );
	...
	if ($submenu_id=='')
	{
		$result1 = $this->Admin_service_model->insert($data1);
	}
	else
	{
         $result1 = $this->Admin_service_model->update($submenu_id,$data1);
	}	
  ...
  public function display_submenu()
	{
		$result['res'] = $this->Admin_service_model->get_submenus();

  	    $this->load->view('display_service',$result);
	}
  ...
  public function editsubmenu()
	{
		...
		$res = $this->Admin_service_model->get_submenusEdit($menuid);
	...
	public function delete_submenu()
	  {
	    ...
	    $image_name = $this->input->post('img');
	        ...
	        $res = $this->Admin_service_model->delete_submenu_part($submenu_id);
