...
<head>
	...
	<body>
		...
		<button class="button button1" onclick="location.href='en/country.php'">English</button>
		<button class="button button2" onclick="location.href='ar/country.php'">Arabic</button>
