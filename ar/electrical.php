...
<div class="contact-innpage">
        <div class="container">
            <h3 class="tittle-w3layouts">ELECTRICAL</h3>
</div></div>
...
&nbsp;
<div class="row">
  <div class="column col-md-4 col-lg-4 col-sm-4 col-xs-12">
    <img class="img-fluid" src="images/ele 1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
  </div>
  <div class="column col-md-4 col-lg-4 col-sm-4 col-xs-12">
    <img class="img-fluid" src="images/ele2.jpg" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
  </div>
  <div class="column col-md-4 col-lg-4 col-sm-4 col-xs-12">
    <img class="img-fluid" src="images/ele3.jpg" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
  </div>
...
<div id="myModal" class="modal ">
  ...
  <div class="modal-content">
    ...
    <div class="mySlides">
      ...
      <img src="images/ele 1.jpg" style="width:100%" "height:100%">
    </div>

    <div class="mySlides" >
      
      <img src="images/ele2.jpg" style="width:100%" "height:100%">
    </div>

    <div class="mySlides" >
      
      <img src="images/ele3.jpg" style="width:100%" "height:100%">
    </div>
