...
<div class="banner_bottom">
		<div class="container">
			<h3 style="text-align: center;padding: 30px;font-size: 40px;" class="tittle-w3ls"><?php echo $res3['service_page_title_arab'] ?></h3>
			<div class="inner_sec_info_wthree_agile">
				<div class="help_full">
					...
					<div class="col-md-12 banner_bottom_left" style="font-size: 20px;">
						...
						<p align="justify"><?php echo $res3['service_page_desc_arab'] ?></p>
					...
					<div class="banner_bottom_pos">
						<div class="banner_bottom_pos_grid">
							...
							<div class="col-xs-10 banner_bottom_grid_right">
							  <h4 style="font-size: 24px;margin-bottom: 10px;"><a href="single_service.php?xfsm=<?php echo $res4['services_id'] ?>"><?php echo $res4['services_name_arab'] ?></a></h4>
								<p align="justify" style="font-size: 18px"><?php echo $res4['services_description_arab'] ?></p>
