...
<?php $s2="SELECT * from services where services_status = 1";
 ...
 { ?>
   							 ...
   							 <a style="font-size:18px;" href="single_service.php?xfsm=<?php echo $res2['services_id'] ?>"><?php echo $res2['services_name_arab'] ?></a>
   <?php } ?>							 
 ...
 { ?>
	...
	<li class="banner1" style="background: url(../admin/uploads/<?php echo $res3['homeslider_pic'] ?>) no-repeat 0px 0px;">
					<div class="container">
                        ...
                        <h3><?php echo $res3['homeslider_title_arab'] ?></h3>
							<h2><font color="#FFFFFF"><?php echo $res3['homeslider_subtitle_arab'] ?></font></h2>
...
<?php
 ...
 ?>				
				<li class="banner2" style="background: url(../admin/uploads/<?php echo $res4['homeslider_pic'] ?>) no-repeat 0px 0px;">
					<div class="container">
						<div class="slider-info-wthree">
							<h3><?php echo $res4['homeslider_title_arab'] ?></h3>
						<h2><font color="#FFFFFF"><?php echo $res4['homeslider_subtitle_arab'] ?></font></h2>
...
<?php
 ...
 ?>					
				<li class="banner3" style="background: url(../admin/uploads/<?php echo $res5['homeslider_pic'] ?>) no-repeat 0px 0px;">
					<div class="container">
						<div class="slider-info-wthree">
							<h3><?php echo $res5['homeslider_title_arab'] ?></h3>
						<h2><font color="#FFFFFF"><?php echo $res5['homeslider_subtitle_arab'] ?></font></h2>
...
?>		<li class="banner3" style="background: url(../admin/uploads/<?php echo $res6['homeslider_pic'] ?>) no-repeat 0px 0px;">
					<div class="container">
						<div class="slider-info-wthree">
							<h3><?php echo $res6['homeslider_title_arab'] ?></h3>
						<h2><font color="#FFFFFF"><?php echo $res6['homeslider_subtitle_arab'] ?></font></h2>
							<!-- <a href="career.php"  class="bnr-button">Join Our Team</a> -->
						</div>
					</div>
				</li>
...
<li class="banner3" style="background: url(../admin/uploads/<?php echo $res7['homeslider_pic'] ?>) no-repeat 0px 0px;">
					<div class="container">
						<div class="slider-info-wthree">
							<h3><?php echo $res7['homeslider_title_arab'] ?></h3>
						<h2><font color="#FFFFFF"><?php echo $res7['homeslider_subtitle_arab'] ?></font></h2>
							<!-- <a href="career.php"  class="bnr-button">Join Our Team</a> -->
						</div>
					</div>
				</li>
