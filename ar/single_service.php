...
<div class="banner_bottom">
		<div class="container">
			<h3 style="text-align: center;font-size: 40px;margin-bottom: 10px;margin-top: 30px" class="tittle-w3ls"><?php echo $res2['services_name_arab'] ?></h3>
			<div class="inner_sec_info_wthree_agile">
				<div class="help_full">
					...
					<div class="col-md-12 banner_bottom_left">
						...
						<p style="font-size: 20px;" align="justify"><?php echo $res2['services_description_arab'] ?></p>
<?php if($servid=='3') {
...
while($res7=$sl7->fetch(PDO::FETCH_ASSOC))
{
 ?>                    
                   ...
                   <p style="margin-top: 10px;margin-bottom: 20px"><a class="sl-btn" target="blank" href="../admin/uploads/<?php echo $res7['catelogs_file'] ?>"><?php echo $res7['catelogs_name'] ?></a></p>
...
$res8=$sl8->fetch(PDO::FETCH_ASSOC);
 ?>                    
                   <p class="col-md-4"></p>
                   <p class="col-md-4" style="margin-top: 10px;margin-bottom: 20px;text-align: center;"><a class="sl-btn" target="blank" href="../admin/uploads/<?php echo $res8['catelogs_file'] ?>">See Price List</a></p>
                   <p class="col-md-4"></p>
...
<?php $s3="SELECT * from products where products_servicetype='$serviceid' and products_status = 1";
 ...
 { ?>
    ...
    <div align="center" class="col-md-4 col-lg-4" style="margin-bottom: 30px;margin-top: 30px;">
    	...
    	<video width="320" height="250" class="hover-shadow cursor col-md-12" style="border-radius: 46px;transition: 0.3s;" controls="controls">
        ...
        <h4 style="font-style: inherit;font-size: 24px;"><b><?php echo $res3['products_name_arab'] ?></b></h4>
