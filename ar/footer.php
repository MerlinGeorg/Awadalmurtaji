<!--footer-w3-->
	<div class="footer-double">
		<div class="bottom-nav-sicons">
			<div class="bottom-nav-main">
				<ul>
					...
					<li>
						<a href="contact.php">الإتصال بنا</a>
					</li>
				</ul>
			</div>
		...
		<div class="newsletter_right">
			<div class="n-left">
				<h3 class="tittle-w3layouts">النشرة الإخبارية</h3>
				<p class="heading-btm" align="right">!احصل على عروضنا الخاصة ونصائح إدارة الأعمال مباشرة إلى بريدك الوارد</p>
			</div>
			<div class="n-right">
