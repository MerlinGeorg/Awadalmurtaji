...
<!-- <html> -->	
	...
	<div class="banner-w3-agileits-btm">
		<div class="container">
			<h3 class="tittle-w3layouts">Welcome to Al Murtaji </h3>
 ...
 ?>
				<div class="banner-w3-agileits-btm-right">
					<h4 class="sub-hdng"><?php echo $res2['about_title'] ?></h4>
				...
				<div class="banner-w3-agileits-btm-left">
					<div class="banner-w3-agileits-btm-top">
						<div class="banner-w3-agileits-btm-inner a1">
							 ...
							 <p align="justify">Our commitment to innovative, original design and quality across a myriad of lighting solutions shines in their 2020 new collections that will allow you to truly express yourself with light. We also deals with Security Systems..</p>
 ...
 while($res4=$sl4->fetch(PDO::FETCH_ASSOC))
{
 ...
 ?>
							 <a href="single_service.php?xfsm=<?php echo $res4['services_id'] ?>"><p class="paragraph-w3-agile"><?php echo $res4['services_name'] ?> </p></a>
			<?php } ?>				 
...
<!-- stats -->
	<div class="stats">
		<div class="container-fluid">
			<h3 class="tittle-w3layouts white-clr" style="color:black;">Our Agencies</h3>
...
<div class="outer-container home-page">
    <div class="container-fluid">
    	...
    	<h3 class="tittle-w3layouts">Our Gallery </h3>
        <div class="row">
 ...
 while($res5=$sl5->fetch(PDO::FETCH_ASSOC))
{
 ...
 ?>       	
            <div class="col-12 col-md-6 col-lg-3 no-padding">
                <div class="portfolio-content">
                    <figure>
                         <img style="height: 200px;width: 310px;" src="../admin/uploads/<?php echo $res5['services_pic'] ?>" alt="">
                    </figure>
		...
		<div class="container">
			<div class="mail-grid1">
				...
				<div class="col-md-4 mail-agileits-w3layouts">
					...
					<div class="contact-right">
						<p>Address</p>
						<span>Abd Alaziz Alkalid building</span>
						<span>Floor No #1, Office No #8</span>
						<span>Tunis Street, Hawally </span>
						<span>Kuwait</span>
