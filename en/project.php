...
<div class="banner_bottom">
		<div class="container">
			<h3 style="text-align: center;padding: 30px;font-size: 40px;" class="tittle-w3ls">PROJECTS</h3>
...
<table class="table">
  ...
  <tbody>
	...
	{ ?>	
	<tr>
      <td><?php echo $res3['project_name'] ;?></td>
      <td><?php echo $res3['project_serialno'] ;?></td>
      <td><?php echo $res3['project_value'] ;?></td>
