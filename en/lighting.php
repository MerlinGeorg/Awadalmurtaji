...
<div class="contact-innpage">
        <div class="container">
            <h3 class="tittle-w3layouts">LIGHTING SOLUTIONS</h3>
</div></div>
...
<div class="row">
  <div class="column">
    <img src="images/light1.jpg" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="images/light2.jpg" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="images/light3.jpg" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
  </div>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="mySlides">
      ...
      <img src="images/light1.jpg" style="width:100%" "height:100%">
    </div>

    <div class="mySlides">
      
      <img src="images/light2.jpg" style="width:100%" "height:100%">
    </div>

    <div class="mySlides">
      
      <img src="images/light3.jpg" style="width:100%" "height:100%">
    </div>
